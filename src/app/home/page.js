...
export default function Home() {
  return (
    <div className="flex flex-col h-screen bg-[#5f3dc4] text-white">
      ...
      {/* Header sticky */}
      <header className="sticky top-0 bg-[#4608ad] p-4 shadow-md z-10">
      ...
      {/* Contenu scrollable */}
      <main className="flex-1 overflow-auto px-6 py-6 -webkit-overflow-scrolling-touch">
        ...
        <p className="text-base text-gray-200 text-center mb-6">
          Suivi des performances & actifs DEFIT1
        </p>
      ...
      {/* Footer sticky */}
      <footer className="sticky bottom-0 bg-[#4608ad] text-sm text-gray-300 text-center py-3">
